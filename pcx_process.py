...
class Pcx_Processor:
    ...
    def get_black_and_white_image(grayscale_data, width, height, threshold: int) -> Image:
        """
    ...
    def get_gamma_transformed_image(grayscale_data, width, height, gamma: float)  -> Image:
        """
        Returns a black and white transformed version of the pcx image as a displayable image
    ...
    def get_neighbors(self, grayscale_data, width, height, coordinates: tuple, radius: int = 1, pad: int = 0, noised_image = None) -> list:
        """
    ...
    def get_median_filtered_image(self, width, height, radius: int = 1, noised_image = None) -> Image:
        """
    ...
    def get_highboost_filtered_image(self, grayscale_data, width, height, A: float = 1) -> Image:
        """
